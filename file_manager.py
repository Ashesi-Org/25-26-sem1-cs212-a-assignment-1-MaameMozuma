...
def process_user_command(choice, running, goodbye_message = "Thank you for using Python CLI File Manager!", 
                        valid_commands = "help, calc, info, quit", show_goodbye = True,
